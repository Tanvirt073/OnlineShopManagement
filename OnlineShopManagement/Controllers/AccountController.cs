...
namespace OnlineShopManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        private string ProcessUploadedFile(RegistrationViewModel model)
        {
        ...
        public async Task<IActionResult> Register(RegistrationViewModel registrationViewModel)
        {
            ...
            {
                string path = ProcessUploadedFile(registrationViewModel);
                var user = new ApplicationUser { UserName = registrationViewModel.Email, Email = registrationViewModel.Email, PhotoPath=path};
